...
namespace LeetCodeProblems.Problems.Easy.ProblemNumber389
{
    public static class TestCases
    {
        public static bool ExcuteSolution()
        {
            ...
            char outPut1 = Solution.FindTheDifference("abcd", "abcde");
            if (outPut1 != 'e')
            {
            ...
            char outPut2 = Solution.FindTheDifference("", "y");
            if (outPut2 != 'y')
            {
            ...
            string testCase3Exp1 = ""; 
            string testCase3Exp2 = ""; 

            char outPut3 = Solution.FindTheDifference(testCase3Exp1, testCase3Exp2);
            if (outPut3 != 't')
            {
                Console.WriteLine("[Problem N389] --> Test Case y didn't work correctly!");
